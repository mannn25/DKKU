...
class Dashboard_student extends CI_Controller {
    ...
    public function index() {
        ...
        $data['bulan'] = $this->Bulan_model->get(array('status'=>0, 'period_status'=>1, 'mahasiswa_id'=> $this->session->userdata('uid_student')));
        $data['bebas'] = $this->Bebas_model->get(array('period_status'=>1, 'mahasiswa_id'=> $this->session->userdata('uid_student')));

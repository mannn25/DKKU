...
<html>
<head>
	<title><?php echo $printpay['mahasiswa_nim'].'_'.$printpay['mahasiswa_full_name'] ?></title>
</head>
		...
		<table style="padding-top: -5px; padding-bottom: 5px">
			<tbody>
				<tr>
					...
					<td style="width: 150px;"><?php echo $printpay['mahasiswa_nim']?></td>
				...
				<tr>
					...
					<td style="width: 5px;">:</td>
					<td style="width: 150px;"><?php echo $printpay['mahasiswa_full_name']?></td>

...
<html>
<head>
	<title><?php foreach ($siswa as $row):?> <?php echo ($f['r'] == $row['mahasiswa_nim']) ? $row['mahasiswa_full_name'] : '' ?><?php endforeach; ?></title>
</head>
		...
		<table style="padding-top: -5px; padding-bottom: 5px">
			<tbody>
				<tr>
					...
					<td style="width: 150px;"><?php echo $row['mahasiswa_nim']?></td>
				<?php endforeach ?>
				...
				<tr>
					...
					<td style="width: 5px;">:</td>
					<?php foreach ($siswa as $row): ?>
					<td style="width: 150px;"><?php echo $row['mahasiswa_full_name']?></td>
					<?php endforeach ?>

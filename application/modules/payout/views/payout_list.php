				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<div class="form-group">						
							<label for="" class="col-sm-2 control-label">Tahun Angkatan</label>
							<div class="col-sm-2">
							...
							<div class="col-sm-3">
								<div class="input-group">
									<input type="text" class="form-control" autofocus name="r" <?php echo (isset($f['r'])) ? 'placeholder="'.$f['r'].'"' : 'placeholder="NIM Mahasiswa"' ?> required>
					...
					<div class="box-body">
						<div class="col-md-9">
							<table class="table table-striped">
								<tbody>
									<tr>
										<td width="200">Tahun Angkatan</td><td width="4">:</td>
										<?php foreach ($period as $row): ?>
									...
									<tr>
										...
										<?php foreach ($siswa as $row): ?>
											<?php echo (isset($f['n']) AND $f['r'] == $row['mahasiswa_nim']) ? 
									...
									<tr>
										...
										<?php foreach ($siswa as $row): ?>
											<?php echo (isset($f['n']) AND $f['r'] == $row['mahasiswa_nim']) ?  
											'<td>'.$row['mahasiswa_name_of_mother'].'</td>' : '' ?> 
										<?php endforeach; ?>
									</tr>
									<tr>
										<td>Kelas</td>
						...
						<div class="col-md-3">
							<?php foreach ($siswa as $row): ?>
								<?php if (isset($f['n']) AND $f['r'] == $row['mahasiswa_nim']) { ?> 
									<?php if (!empty($row['mahasiswa_img'])) { ?>
										<img src="<?php echo upload_url('student/'.$row['mahasiswa_img']) ?>" class="img-thumbnail img-responsive">
									<?php } else { ?>
										...
										<table class="table table-bordered" style="white-space: nowrap;">
											...
											<tbody>
												...
												foreach ($student as $row):
													if ($f['n'] AND $f['r'] == $row['mahasiswa_nim']) {
														?>
														<tr>
															<td><?php echo $i ?></td>
													...
													foreach ($bebas as $row):
														if ($f['n'] AND $f['r'] == $row['mahasiswa_nim']) {
															...
															<tr class="<?php echo ($row['bebas_bill'] == $row['bebas_total_pay']) ? 'success' : 'danger' ?>">
																...
																<td><a href="<?php echo site_url('manage/payout/payout_bebas/'. $row['payment_payment_id'].'/'.$row['student_mahasiswa_id'].'/'.$row['bebas_id']) ?>" class="view-cicilan label <?php echo ($row['bebas_bill']==$row['bebas_total_pay']) ? 'label-success' : 'label-warning' ?>"><?php echo ($row['bebas_bill']==$row['bebas_total_pay']) ? 'Lunas' : 'Belum Lunas' ?></a></td>
																...
																<div class="modal-dialog modal-md">
																	<div class="modal-content">
																		...
																		<div class="modal-body">
																			...
																			<input type="hidden" name="mahasiswa_nim" value="<?php echo $row['mahasiswa_nim'] ?>">
																			<input type="hidden" name="student_mahasiswa_id" value="<?php echo $row['student_mahasiswa_id'] ?>">

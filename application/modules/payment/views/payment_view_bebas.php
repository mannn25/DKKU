							...
							<tbody>
								...
								foreach ($student as $row):
									...
									<tr>
										...
										<td>
											<a href="<?php echo site_url('manage/payment/edit_payment_bebas/'. $row['payment_payment_id'].'/'.$row['student_mahasiswa_id'].'/'.$row['bebas_id']) ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Ubah Tarif"><i class="fa fa-edit"></i></a>
											<a href="<?php echo site_url('manage/payment/delete_payment_bebas/'. $row['payment_payment_id'].'/'.$row['student_mahasiswa_id'].'/'.$row['bebas_id']) ?>" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Hapus Pembayaran" onclick="return confirm('<?php echo 'Apakah anda akan menghapus pembayaran a.n '.$row['mahasiswa_full_name'].'?' ?>')"><i class="fa fa-trash"></i></a>
										</td>	
									</tr>
									<?php
									$i++;

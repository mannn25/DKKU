...
if (isset($bulan)) {
	...
	$inputStudentValue = $bulan['mahasiswa_id'];
	$inputClassValue = $bulan['class_id'];
	$inputBillValue = $bulan['bulan_bill'];
} else {
	$inputStudentValue = set_value('student_mahasiswa_id');
					...
					<div class="col-md-5">
						<div class="box box-primary">
							...
							<div class="box-body">
								...
								<div class="form-group">						
									<label for="" class="col-sm-4 control-label">Tahun Angkatan</label>
									<div class="col-sm-8">
									...
									<div id="selTask">
										...
										<div class="col-sm-8">
											<select name="mahasiswa_id" class="form-control">
												...
												<option ng-repeat="student in students" ng-selected="student_data.index == student.mahasiswa_id" value="{{student.mahasiswa_id}}">{{student.mahasiswa_full_name}}</option>
											</select>
										</div>
									</div>
								</div>

...
class Bulan_model extends CI_Model {
    ...
    function get($params = array())
    {
        ...
        {
            $this->db->where('bulan.student_mahasiswa_id', $params['mahasiswa_id']);
        }
        ...
        {
            $this->db->where('mahasiswa_nim', $params['mahasiswa_nim']);
        }
        ...
        $this->db->group_by('bulan.student_mahasiswa_id'); 
        ...
        $this->db->select('student_mahasiswa_id, mahasiswa_img, mahasiswa_nim, mahasiswa_full_name, mahasiswa_name_of_mother, mahasiswa_parent_phone, student.class_class_id, student.majors_majors_id, majors_name, majors_short_name, class_name');
        ...
        $this->db->select('bulan.student_mahasiswa_id, bulan.student_mahasiswa_id');
        $this->db->join('month', 'month.month_id = bulan.month_month_id', 'left');

        $this->db->join('student', 'student.mahasiswa_id = bulan.student_mahasiswa_id', 'left');
    ...
    function get_total($params = array())
    {
        ...
        $this->db->select('student_mahasiswa_id, mahasiswa_img, mahasiswa_nim, mahasiswa_full_name, mahasiswa_name_of_mother, student.class_class_id, student.majors_majors_id, majors_name, majors_short_name, class_name');
    ...
    if(isset($data['mahasiswa_id'])) {
        $this->db->set('student_mahasiswa_id', $data['mahasiswa_id']);
    }

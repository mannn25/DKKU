...
// Get From Databases
  function get($params = array())
  {
    ...
    {
      $this->db->where('bebas.student_mahasiswa_id', $params['mahasiswa_id']);
    }
    ...
    if(isset($params['group']))
    {
      ...
      $this->db->group_by('bebas.student_mahasiswa_id'); 
    ...
    $this->db->select('student_mahasiswa_id,  student.class_class_id, class_name, mahasiswa_full_name, mahasiswa_nim, mahasiswa_name_of_mother, mahasiswa_parent_phone, student.majors_majors_id, majors_name, majors_short_name');
    $this->db->select('payment_payment_id, pos_name, payment_type, period_period_id, period_start, period_end');
    $this->db->join('student', 'student.mahasiswa_id = bebas.student_mahasiswa_id', 'left');
...
// Delete bebas to database
  function delete_bebas($params = array()) {
    ...
    if (isset($params['mahasiswa_id'])) {
      $this->db->where('student_mahasiswa_id', $params['mahasiswa_id']);
    }

...
class Bebas_pay_model extends CI_Model {
    ...
    function get($params = array())
    {
        ...
        $this->db->select('student_mahasiswa_id, mahasiswa_nim, student.class_class_id, class_name, mahasiswa_full_name, mahasiswa_name_of_mother, mahasiswa_parent_phone');

					...
					<div class="box-body">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs">
								...
								<li><a href="#tab_2" data-toggle="tab">Data Kampus</a></li>
							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab_1">
									...
									<div class="form-group">
										...
										<input name="mahasiswa_full_name" type="text" class="form-control" value="<?php echo $inputFullnameValue ?>" placeholder="Nama lengkap">
									</div>
									<div class="form-group">
								...
								<div class="tab-pane" id="tab_2">
									<div class="form-group">
										...
										<input name="mahasiswa_nim" type="text" class="form-control" value="<?php echo $inputNisValue ?>" placeholder="NIM Mahasiswa">
									</div> 

									<?php if (!isset($student)) { ?>
										<div class="form-group">
											<label>Password <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
											<input name="mahasiswa_password" type="password" class="form-control" placeholder="Password">
										</div>            
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="radio">
								<label>
									<input type="radio" name="mahasiswa_status" value="1" <?php echo ($inputStatusValue == 1) ? 'checked' : ''; ?>> Aktif
								</label>
							</div>
							<div class="radio">
								<label>
									<input type="radio" name="mahasiswa_status" value="0" <?php echo ($inputStatusValue == 0) ? 'checked' : ''; ?>> Tidak Aktif
								</label>
							</div>
						</div>
						<label >Foto</label>
						<a href="#" class="thumbnail">
							<?php if (isset($student['mahasiswa_img']) != NULL) { ?>
						...
						<input type='file' id="mahasiswa_img" name="mahasiswa_img">
						<br>
						<button type="submit" class="btn btn-block btn-success">Simpan</button>
						<a href="<?php echo site_url('manage/student'); ?>" class="btn btn-block btn-info">Batal</a>
						<?php if (isset($student)) { ?>
							<button type="button" onclick="getId(<?php echo $student['mahasiswa_id'] ?>)" class="btn btn-danger btn-block" data-toggle="modal" data-target="#deleteStudent">Hapus
							</button>
						<?php } ?>
					</div>
					<!-- /.box-body -->
			...
			<div class="modal-content">
				...
				<form action="<?php echo site_url('manage/student/delete') ?>" method="POST">
					<div class="modal-body">
						...
						<input type="hidden" name="mahasiswa_id" id="studentId">
					</div>
					<div class="modal-footer">

...
class Log_trx_model extends CI_Model {
    ...
    function get($params = array()) {
        ...
        if (isset($params['mahasiswa_id'])) {
            $this->db->where('log_trx.student_mahasiswa_id', $params['mahasiswa_id']);
        }
        ...
        $this->db->select('bulan_bulan_id, log_trx.student_mahasiswa_id, mahasiswa_nim, bulan_bill, month_name, bebas_pay_bill');
        ...
        $this->db->join('student', 'student.mahasiswa_id = log_trx.student_mahasiswa_id', 'left');
    ...
    function add($data = array()) {
        ...
        if (isset($data['student_mahasiswa_id'])) {
            $this->db->set('student_mahasiswa_id', $data['student_mahasiswa_id']);
        }

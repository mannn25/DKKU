    ...
    <div class="col-md-12">
      <div class="box box-info box-solid" style="border: 1px solid #2ABB9B !important;">
        <div class="box-header backg with-border">
          <h3 class="box-title">Cek Data Pembayaran Mahasiswa</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
          ...
          <div class="form-group">            
            ...
            <div class="col-sm-2">
              <input type="text" autofocus name="r" <?php echo (isset($f['r'])) ? 'placeholder="'.$f['r'].'"' : 'placeholder="NIM Mahasiswa"' ?> class="form-control" required>
            </div>

            <div class="col-sm-4">
              <button type="submit" class="btn btn-success"><i class="fa fa-search"> </i> Cari Mahasiswa</button>
            </div>
          </div>
        </form>
      </div><!-- /.box-body -->
              ...
              <table class="table table-striped table-hover" style="cursor: pointer;">
                ...
                <tbody>
                  ...
                  foreach ($student as $row):
                    ...
                    if (isset($f['n']) AND $f['r'] == $row['mahasiswa_nim']) {
                      ?>

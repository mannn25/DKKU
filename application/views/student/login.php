  ...
  <div class="row">
    <div class="col-md-5">
      <div class="logo hidden-xs hidden-sm">
        ...
        <img src="<?php echo media_url('img/uniba.png') ?>" class="img-responsive">
        <?php } else { ?>
        <img src="<?php echo upload_url('school/' . $setting_logo['setting_value']) ?>" class="img-responsive">
        <?php } ?>
      </div>
      <p class="merk"><span style="color: #2ABB9B">DKKU</span> APP</p> 
      <?php if (isset($setting_school) AND $setting_school['setting_value'] == '-') { ?>
      <p class="school">Data Keuangan Kampus Uniba</p> 
      <?php } else { ?>
    ...
    <div class="col-md-7">
      <div class="box">
        ...
        <div class="col-md-12">
          <p class="title-login">Mahasiswa Login</p>
          <?php if ($this->session->flashdata('failed')) { ?>
          <br><br>
        <div class="alert alert-danger alert-dismissible" style="margin-top: -85px !important;">
          <h5><i class="fa fa-close"></i> NIM atau Password salah!</h5>
        </div>
        <?php  }  ?>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>NIM</label>
                <input type="text" required="" autofocus="" name="nis" placeholder="Masukan NIM" class="form-control flat">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">

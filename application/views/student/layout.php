...
<head>
  ...
  <link rel="icon" type="image/png" href="<?php echo media_url('ico/uniba.png') ?>">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php site_url('student') ?>" class="logo">
        ...
        <?php } else { ?>
        <span class="logo-mini"><img src="<?php echo media_url('img/uniba.png') ?>" style="height: 40px; margin-top: 5px; margin-left:5px;" class="pull-left"></span>
        <?php } ?>
        <?php if (!empty(logo())) { ?>
        ...
        <?php } else { ?>
        <span class="logo-lg"><img src="<?php echo media_url('img/uniba.png') ?>" style="height: 40px; margin-top: 5px;" class="pull-left"><b>&nbsp;<?php echo $this->config->item('app_name') ?></b></span>
        <?php } ?>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <?php if ($this->session->userdata('mahasiswa_img') != null) { ?>
                <img src="<?php echo upload_url().'/student/'.$this->session->userdata('mahasiswa_img'); ?>" class="user-image">
                <?php } else { ?>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  <?php if ($this->session->userdata('mahasiswa_img') != null) { ?>
                  <img src="<?php echo upload_url().'/student/'.$this->session->userdata('mahasiswa_img'); ?>" class="img-circle">
                  <?php } else { ?>
